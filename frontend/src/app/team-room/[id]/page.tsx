...
<div className="bg-zinc-900 border border-red-700 rounded-3xl p-8 text-center">
...
<main className="flex-1 p-4 pt-20 md:ml-64 md:p-10">
...
<div
key={slot.id}
className="bg-zinc-800 rounded-xl p-4 min-h-[120px] flex flex-col justify-center items-center text-center"
>
...
className="mt-2 bg-green-600 px-4 py-2 rounded-lg text-sm font-bold"
